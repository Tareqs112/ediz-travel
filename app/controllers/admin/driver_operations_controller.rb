class Admin::DriverOperationsController < Admin::BaseController
  ...
  def show
    ...
    @services = @driver.trip_services
      .where(date: @date)
      .includes(booking: [:customer, :booking_request, :trip_inquiry], vehicle: [])
